...
public void larry_searches_for_products_in_search_field(io.cucumber.datatable.DataTable dataTable) {
...
public void larry_verifies_the_product_available() {
	...
	public void alex_got_refunded_of_dollars(Integer int1) {
	    // Write code here that turns the phrase above into concrete actions
	    //throw new cucumber.api.PendingException();
		System.out.println("Alex got refunded");
	}
	...
	@Given("executive added items to cart")
	public void executive_added_items_to_cart() {
	    // Write code here that turns the phrase above into concrete actions
	    //throw new cucumber.api.PendingException();
	}
